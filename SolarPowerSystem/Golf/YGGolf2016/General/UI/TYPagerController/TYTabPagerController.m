...
- (void)viewWillLayoutSubviews
{
    ...
    _pagerBarTabBar.frame = _pagerBarView.bounds;
    _splitLineView.frame = CGRectMake(0, _pagerBarView.height - 1, _pagerBarView.width, 0.5);
...
-(void) addPagerBarTabBar
{
    UITabBar *barTabBar = [[UITabBar alloc]initWithFrame:_pagerBarView.bounds];
    [_pagerBarView addSubview:barTabBar];
    _pagerBarTabBar = barTabBar;
    
}

-(void) addSplitLineView
{
    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(0, _pagerBarView.height - 1, _pagerBarView.width, 0.5)];
    _splitLineView = lineView;
    _splitLineView.backgroundColor = [UIColor colorWithHexString:@"#bbbbbb"];
    [_pagerBarView addSubview:lineView];
}
